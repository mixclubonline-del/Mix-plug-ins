...
class MixxBrainwaveVstBridge extends VstBridge<MixxBrainwaveSettings> {
    ...
    // FIX: Add explicit constructor to ensure 'this' context and settings are correctly initialized.
    constructor(initialSettings: MixxBrainwaveSettings) {
        super(initialSettings);
    }
    // FIX: Convert dspProcess to a method to bind 'this' context correctly.
    public dspProcess(
